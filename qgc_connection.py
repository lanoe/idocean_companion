...
# Code used from https://github.com/waterlinked/blueos-ugps-extension/blob/master/app/qgc_connection.py
...
class QgcConnection:
    ...
    def __init__(self, ip: str = "192.168.2.1", port: int = 14401):
        ...
        # Use UDP port 14401 to send NMEA data to QGC for locator location
